...
class ArFragment : Fragment(R.layout.fragment_ar) {
    ...
    private fun initObjects() {
        MaterialFactory.makeOpaqueWithColor(requireContext(), Color(Color.rgb(255, 222, 173)))
        ...
        MaterialFactory.makeTransparentWithColor(requireContext(), Color(Color.rgb(255, 222, 230)))
            .thenAccept { material: Material? ->
        ...
        MaterialFactory.makeOpaqueWithColor(requireContext(), Color(Color.rgb(23, 107, 230)))
            .thenAccept { material: Material? ->
